...
public abstract class BaseCrudServiceImpl implements BaseCrudService{
	...
	public   <ModelType,ModelCustomerType>  void deleteMasterCustomer(List<ModelType> listModelCustomerType, Class<ModelCustomerType> customerClazz, String idFieldName,String customerName, SystemUser systemUser){}
